...
- Imported project setup (2026-07-09): registered artifacts + workflows for fruit-blaster, api-server, and the mockup-sandbox canvas, ran `pnpm install`, started both services, and verified the game loads in preview. `DATABASE_URL` is already set in the environment.
